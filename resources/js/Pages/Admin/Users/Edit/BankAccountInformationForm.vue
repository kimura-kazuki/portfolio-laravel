...
const form = useForm({
    ...
    bank_account_holder_type_code: props.userBank?.bank_account_holder_type_code,
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                >
                    ...
                    <option v-for="bankAccountHolderTypeCodeOption in bankAccountHolderTypeCodeOptions" :value="bankAccountHolderTypeCodeOption.value">
