...
<template>
    <AppLayout>
        <template #topnav>
            <div>
                <Link :href="route('admin.users.index')" class="gap-2 normal-case bg-white shadow-sm btn btn-sm md:btn-md btn-ghost lg:gap-3">
                ...
                <template #form>
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <select
                            ...
                            id="role"
                            class="
                                border border-gray-300 text-gray-900 rounded-lg
                                focus:ring-blue-500 focus:border-blue-500 block w-full mt-1 p-2.5
                            "
                            @keypress.enter.prevent
                        >
                            <option disabled selected>選択して下さい</option>
                            <option v-for="(userRole, index) in userRoles" :value="index">
                                {{ userRole }}
                            </option>
                        </select>
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        <JetLabel for="password" value="パスワード（8桁以上で入力してください）" />
                        <JetInput
                            id="password"
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        <JetLabel for="password_confirmation" value="パスワード（確認用）" />
                        <JetInput
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        />
                        <JetInputError :message="form.errors.bank_branch_name" class="mt-2" />
                    </div>

                    <div class="col-span-6 sm:col-span-6">
                        <JetLabel for="bank_account_holder_type_code" value="口座種別" />
                        <select
                        ...
                        >
                            ...
                            <option v-for="(bankAccountHolderTypeOption) in bankAccountHolderTypeOptions" :value="bankAccountHolderTypeOption.code">
                                {{ bankAccountHolderTypeOption.name }}
                            </option>
                        </select>
                        <JetInputError :message="form.errors.bank_account_holder_type_code" class="mt-2" />
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        />
                        <JetInputError :message="form.errors.bank_account_holder_name" class="mt-2" />
                    </div>
