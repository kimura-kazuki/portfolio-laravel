        ...
        <JetBarContainer>
            ...
            <div class="grid grid-cols-3 gap-6 mt-5">
                ...
                <div class="col-span-3 space-y-5 xl:col-span-1">
                    <div class="-mx-4 overflow-hidden bg-white shadow sm:rounded-lg sm:-mx-0">
                        ...
                        <div class="px-4 py-6 sm:p-6">
                            <div class="-m-6 -mx-4 divide-y divide-gray-200 sm:-mx-6">
                                ...
                                <div class="px-3 py-4 text-sm sm:py-5 sm:px-6">
                                    ...
                                    <ul class="mt-3 space-y-1">
                                        ...
                                        <li class="">
                                            〒 {{ user.user_locations[0]?.postal_code }}
                                        </li>
                                        <li class="">
                                            {{ user.user_locations[0]?.prefecture?.name }}
                                        </li>
                                        <li class="">
                                ...
                                <div class="px-3 py-4 text-sm sm:py-5 sm:px-6">
                                    ...
                                    <address class="mt-2 not-italic">
                                        ...
                                        {{ userBank?.bank_account_holder_type_code }}<br />
                                        {{ userBank?.bank_account_number }}<br />
