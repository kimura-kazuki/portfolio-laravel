...
<template>
    <div
        class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white lg:w-64 dark-mode:text-gray-200 dark-mode:bg-gray-800 lg:border-r"
    >
        <div
            class="flex flex-row items-center justify-between flex-shrink-0 px-4 py-4 lg:px-8"
        >
            <!-- App Title -->
            ...
            <div class="flex flex-row">
                ...
                <template v-if="$page.props.auth.user.role_name == 'Admin'">
                    <button
                        class="relative flex mx-4 text-gray-600 focus:outline-none lg:hidden"
                        @click="
                ...
                <button
                    class="px-2 rounded-lg lg:hidden focus:outline-none focus:shadow-outline"
                    @click="
        ...
        <template v-if="$page.props.auth.user.role_name == 'Admin'">
            ...
            <div
                v-show="showingNotificationDropdown"
                class="z-10 flex-grow px-4 pb-4 lg:block lg:pb-0 lg:overflow-y-auto"
                style="display: none"
            >
                ...
                <template
                    v-for="adminTask in $page.props.auth.adminTasks"
                    :key="adminTask.id"
                >
                    <a
                        :href="route('admin.admin-tasks.edit', adminTask.id)"
                        class="flex items-center px-4 py-3 -mx-2 text-gray-600 hover:bg-gray-100"
                    >
                        <figure class="w-1/6">
                            <img
        ...
        >
            ...
            >
                ...
                <span class="justify-between w-full lg:flex"
                    ><div class="flex">ダッシュボード</div></span
                >
            </Link>
            ...
            >
                ...
                <span class="justify-between w-full lg:flex"
                    ><div class="flex">ユーザー管理</div></span
                >
            </Link>
        ...
        <small
            class="hidden mx-3 mt-1 mb-2 text-center opacity-50 lg:block"
            style="font-size: 0.5rem"
            >© 2023 Laravel Portfolio</small
        >
